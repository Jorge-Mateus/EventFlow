...
namespace EventFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260528220209_AddContrato")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventFlow.Domain.Entities.Contrato", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventFlow.Domain.Entities.EventoFornecedor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventFlow.Domain.Entities.Fornecedor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventFlow.Domain.Entities.MovimentacaoFinanceira", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventFlow.Domain.Entities.EventoFornecedor", b =>
                {
                    ...
                    b.HasOne("EventFlow.Domain.Entities.Fornecedor", "Fornecedor")
                        .WithMany("Eventos")
